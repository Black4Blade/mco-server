 ...
 */
function createDB () {
  sqlite.open ('./data/sessions.db').then (db => {
    const status = db.run (
 ...
 */
function fetchSessionKeyByConnectionId (connectionId) {
...
function updateSessionKey (customerId, sessionKey, contextId, connectionId) {
...
module.exports = {createDB, fetchSessionKeyByConnectionId, updateSessionKey};
